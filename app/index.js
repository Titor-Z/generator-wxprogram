...
class wxprogram extends Generator {
  ...
  async prompting() {
    ...
    this.answers = await this.prompt([
      ...
      },
      {
        ...
        message: "使用TS还是JS ?",
        choices: [
          { name: "JavaScript", value: 0, checked: true },
  ...
  writing() {
    ...
    this._copy([
      ...
      {
        src: "miniprogram/pages/index/index.styl",
        obj: `${workDir}miniprogram/pages/index/index.styl`
      },
      {
        src: "miniprogram/pages/index/index.wxml",
        obj: `${workDir}miniprogram/pages/index/index.wxml`
      },
      {
        src: "miniprogram/pages/index/logo.svg",
        obj: `${workDir}miniprogram/pages/index/logo.svg`
      },
      {
        src: "miniprogram/pages/index/footer.svg",
  ...
  _copy(files) {
    files.forEach(file => {
      this.fs.copy(this.templatePath(file.src), this.destinationPath(file.obj))
    })
  }
